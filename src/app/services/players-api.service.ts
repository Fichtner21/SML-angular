...
public getJsonSeason(name: string, path: string): Observable<any[]> {
  ...
  public createPlayer(
    ...
    warcount: string, nationality: string, clanhistory: string, cup1on1edition1: string, meeting: string, cup3on3: string, active: string, ban: boolean, lastwar: string, fpw: string, fpwmax: string, fpwmin: string, last30days: string,  last365days: string, lastwarpc: string, s1wars: string, s2wars: string, s3wars: string, s4wars: string, s5wars: string, s6wars: string, s1fpw: string, s2fpw: string, s3fpw: string, s4fpw: string, s5fpw: string, s6fpw: string, streak: string
    ): Observable<Sheet>{
